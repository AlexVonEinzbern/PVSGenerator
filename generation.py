...
result_dir = '/outputs_generation'  # folder where examples will be saved
...
path_label_map = '~/Escritorio/brain_generator/pvs_training_segs'
...
#
generation_labels = [0,    # background
                     69,   # PVS 
                     24,   # CSF
...
output_labels = [0, 69, 0, 0, 2, 3, 4, 17, 41, 42, 43, 53]
...
# output_labels = 'data/labels_classes_priors/synthseg_segmentation_labels_pvs.npy'
...
#
# Example: (continuing the previous one) generation_labels = [0, 69, 24, 507, 2, 3, 4, 17, 41, 42, 43, 53]
generation_classes= [0, 1, 1, 2, 3, 4, 5, 4, 6, 7, 8, 8]
